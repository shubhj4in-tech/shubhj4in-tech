...
I built **Aapka Nyay**, India’s largest legal-aid AI platform (142,000+ users), designing a multilingual RAG pipeline over IPC/CrPC and state acts with safety filtering and human escalation before the system was acquired. I co-founded **Dravn**, a community-driven fitness app with an embedded AI recovery engine, building the iOS MVP on Supabase and designing its behavioral and insight architecture. I’ve also worked on growth and infrastructure systems at YC-backed **Friday**, and at **Fish Audio**, where I built creator acquisition and API adoption systems for a $4M ARR generative AI company.
